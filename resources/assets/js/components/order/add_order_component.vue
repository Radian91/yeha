<template>
    <div class="row m-0">
        ...
        <div class="col-md-8 p-0 bg-white border-right">
            ...
            <div class="p-0 border-bottom">
                <div class="d-flex flex-nowrap justify-content-between p-3 horizontal-scroll hide-horizontal-scroll">
                    ...
                    <button class="btn btn-danger ml-3" v-on:click="close_register"> <i class="fas fa-cash-register"></i>&ensp;<span v-if="parent_register ==1">{{ $t("Close Register") }}</span><span v-else>{{ $t("Exit Register") }}</span></button>
                </div>
            </div>
        ...
        <modalcomponent v-if="show_close_register_modal" v-on:close="show_close_register_modal = false">
            <template v-slot:modal-header>
                <label for="close_register">
                    <span v-if="parent_register == 1">{{ $t("Close Register") }}</span>
